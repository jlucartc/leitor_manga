Rails.application.routes.draw do
  ...
  get "/manga/ler/:id", to: "manga#ler_manga", as: "ler_manga"
  ...
  get "/api/manga/ver/:id", to: "api#ver_manga", as: "api_ver_manga"
  get "/api/manga/buscar", to: "api#buscar_manga", as: "api_buscar_manga"
  get "/api/manga/ler/:id", to: "api#ler_manga", as: "api_ler_manga"
